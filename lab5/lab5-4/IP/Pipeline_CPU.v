...
module Pipeline_CPU(
    ...
    Pipeline_IF pipe_if (.clk_IF(clk),
                         .rst_IF(rst),
                         .en_IF(en_IF_0),
    ...
    Pipeline_Ex pipe_ex(.PC_in_EX(PC_out_IDEX_0),
    ...
    Pipeline_Mem pipe_mem(.zero_in_Mem(zero_out_EXMem_0),
    ...
    Mem_reg_WB mem_reg_wb(.clk_MemWB(clk),
     ...
     Pipeline_WB pipe_wb(.PC4_in_WB(PC4_out_MemWB_0),
