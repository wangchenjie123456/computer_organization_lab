...
#
# Script generated by Vivado on Mon Nov 24 22:15:18 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : whilenwe.sh
...
#
# Usage        : whilenwe.sh
#                whilenwe.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                whilenwe.sh [-reset_run]
#                whilenwe.sh [-reset_log]
#                whilenwe.sh [-help]
#
...
# script info
echo -e "whilenwe.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./whilenwe.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot whilenwe xil_defaultlib.whilenwe xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim whilenwe -key {Behavioral:sim_1:Functional:whilenwe} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb whilenwe.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./whilenwe.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: whilenwe.sh [-help]\n\
Usage: whilenwe.sh [-step]\n\
Usage: whilenwe.sh [-lib_map_path]\n\
Usage: whilenwe.sh [-reset_run]\n\
Usage: whilenwe.sh [-reset_log]\n\
Usage: whilenwe.sh [-keep_index]\n\
Usage: whilenwe.sh [-noclean_files]\n\n\
