...
#
# Script generated by Vivado on Mon Nov 24 22:17:21 +0800 2025
...
#
# Usage        : fakeRAM.sh
#                fakeRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fakeRAM.sh [-reset_run]
#                fakeRAM.sh [-reset_log]
#                fakeRAM.sh [-help]
#
...
# script info
echo -e "fakeRAM.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fakeRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fakeRAM xil_defaultlib.fakeRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fakeRAM -key {Behavioral:sim_1:Functional:fakeRAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fakeRAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fakeRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fakeRAM.sh [-help]\n\
Usage: fakeRAM.sh [-step]\n\
Usage: fakeRAM.sh [-lib_map_path]\n\
Usage: fakeRAM.sh [-reset_run]\n\
Usage: fakeRAM.sh [-reset_log]\n\
Usage: fakeRAM.sh [-keep_index]\n\
Usage: fakeRAM.sh [-noclean_files]\n\n\
