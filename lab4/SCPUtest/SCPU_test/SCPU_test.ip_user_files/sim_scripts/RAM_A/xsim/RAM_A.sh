...
#
# Script generated by Vivado on Sun Nov 23 15:34:10 +0800 2025
...
#
# Usage        : RAM_A.sh
#                RAM_A.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RAM_A.sh [-reset_run]
#                RAM_A.sh [-reset_log]
#                RAM_A.sh [-help]
#
...
# script info
echo -e "RAM_A.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RAM_A.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RAM_A xil_defaultlib.RAM_A xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RAM_A.wdb xsim.dir libdpi.so)
...
Usage: RAM_A.sh [-reset_log]\n\
Usage: RAM_A.sh [-keep_index]\n\
