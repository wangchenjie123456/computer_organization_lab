...
#
# Script generated by Vivado on Sun Nov 23 15:31:44 +0800 2025
...
# script info
echo -e "ROM_B.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_B xil_defaultlib.ROM_B xil_defaultlib.glbl -log elaborate.log
}
